...
<!-- ИМЯ -->
<div align="center">
  <p style="font-size: 24px; color: #FF69B4; font-weight: bold; font-style: italic;">
    𝘈𝘭𝘦𝘩𝘢 / 𝘈𝘭𝘦𝘹𝘢
  </p>
</div>
...
<!-- ФОТО -->
<div align="center">
  <img src="https://github.com/1banny/1banny/blob/main/anime.png?raw=true" 
       width="200" 
       style="border-radius: 15px; box-shadow: 0 0 20px rgba(255,105,180,0.3);">
</div>

<!-- ГИФКА В ЛЕВОМ НИЖНЕМ УГЛУ -->
...
<div align="center">
  <img src="https://github.com/1banny/1banny/blob/main/bib.gif?raw=true" 
       ...
       style="border-radius: 15px; 
              ...
              display: block;">
</div>  <img src="https://github.com/1banny/1banny/blob/main/ezgif-817ebfe25b8b024d.gif?raw=true" 
       width="150" 
       style="border-radius: 15px; 
              box-shadow: 0 0 20px rgba(255, 105, 180, 0.3);
              border: 2px solid #FFB6C1;">
